...
public class BoardController {
    ...
    @GetMapping("/{boardId}")
    public String boardDetail(Model model, @PathVariable(name = "boardId") Long boardId){
    ...
    public ResponseEntity<String> newBoard(@Valid @ModelAttribute BoardRequest boardRequest, BindingResult bindingResult){
        ...
        Long newBoardId = boardService.create(boardRequest);
        return ResponseEntity.ok(newBoardId.toString());
    }
